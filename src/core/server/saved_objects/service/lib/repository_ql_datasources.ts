...
import { OpenSearchClient, DeleteDocumentResponse, ILegacyClusterClient } from '../../../opensearch';
...
export interface QlSavedObjectsRepositoryOptions {
  index: string;
 ...
 * @public
 */
export type IQlSavedObjectsRepository = Pick<QlSavedObjectsRepository, keyof QlSavedObjectsRepository>;

/**
 * @public
 */
export class QlSavedObjectsRepository {
  ...
  public static createRepository(
    ...
    injectedConstructor: any = QlSavedObjectsRepository
  ): IQlSavedObjectsRepository {
  ...
  public constructor(options: QlSavedObjectsRepositoryOptions) {
    const {
      index,
      mappings,
      client,
  ...
  public async create<T = unknown>(
    ...
    const { body } =
      id && overwrite
        ? await this.client.C(requestParams)
